...
namespace Ncqrs.Extensions.WindowsAzure.Eventing.ServiceModel.Bus {
    public static class RegisterAllHandlersInAssemblyExtension {
        ...
        public static void RegisterAllHandlersInAssembly(this HandlingBus target, Assembly asm) {
            target.RegisterAllHandlersInAssembly(asm, CreateInstance);
        }

        public static void RegisterAllHandlersInAssembly(this HandlingBus target, Assembly asm, Func<Type, object> handlerFactory) {
        ...
        private static void RegisterHandler(object handler, Type eventDataType, HandlingBus target) {
